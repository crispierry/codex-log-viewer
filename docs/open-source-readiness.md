...
The tag-based Release workflow sets `CODEX_LOG_VIEWER_REQUIRE_NOTARIZATION=1`, so official GitHub Releases fail closed until those secrets and the matching runner keychain setup are present.
